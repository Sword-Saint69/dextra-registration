                        ...
                        {['Home', 'Events', 'Gallery', 'Certificates', 'Contact'].map((item, i) => (
                            ...
                            >
                                <Link
                                    ...
                                    className={`group relative transition-colors text-sm font-medium leading-normal ${item === 'Certificates' ? 'text-accent-gold' : 'text-white/80 hover:text-white'}`}
                                >
                                    {item}
                                </Link>
                            </motion.div>
