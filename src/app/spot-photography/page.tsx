...
export default function SpotPhotographyPage() {
    ...
    useEffect(() => {
        ...
        // Fetch from spot_media collection
        const q = query(
            collection(db, 'spot_media'),
                ...
                <section className="relative z-10 px-6 py-16 md:py-24 max-w-[1400px] mx-auto">
                    ...
                    {galleryItems.length === 0 && (
                        ...
                        >
                            ...
                            <p className="text-white/30 font-sans tracking-widest uppercase text-sm">No photos yet. Be the first to share!</p>
                        </motion.div>
                    )}
                        ...
                        <div className="mt-20 flex justify-center">
                            <Magnetic>
                                ...
                                >
                                    ...
                                    <span className="relative z-10">{loading ? 'Loading...' : 'Load More Photos'}</span>
                                </button>
                            </Magnetic>
                        </div>
                    )}
